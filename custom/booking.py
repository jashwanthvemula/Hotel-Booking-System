...
def confirm_booking():
    ...
    try:
        ...
        # Go to user profile to see booking
        nav_frame.go_to_profile()
...
# ----------------- Main Function -----------------
def main():
    global app, hotel_name_label, hotel_location_label, room_type_dropdown, checkin_entry, checkout_entry
    global guests_entry, payment_var, summary_hotel_label, summary_location_label, summary_room_label
    global summary_price_label, summary_nights_label, summary_total_label, nav_frame
